		...
		.then(function(results2) {	
			...
			for(var i = 0 ; i < results.length ; i++)
			{
				if(results[i].sfid != null)
				{
					...
					if(results[i].plan_start__c != null) body2 += '"Plan_Start__c":"' + results[i].start.replace(" ", "T") + '", ';
					if(results[i].plan_end__c != null) body2 += '"Plan_End__c":"' + results[i].end.replace(" ", "T") + '", ';
					...
					if(results[i].check_in_time__c != null) body2 += '"Check_In_Time__c":"' + results[i].check_in_time.replace(" ", "T") + '", ';
					...
					if(results[i].check_out_time__c != null) body2 += '"Status__c":"' + results[i].check_out_time.replace(" ", "T") + '", ';
				...
				else
				{
					...
					if(results[i].plan_start__c != null) body += '"Plan_Start__c":"' + results[i].plan_start__c + '", ';
					if(results[i].plan_end__c != null) body += '"Plan_End__c":"' + results[i].plan_end__c + '", ';
					...
					if(results[i].check_in_time__c != null) body += '"Check_In_Time__c":"' + results[i].check_in_time.replace(" ", "T") + '", ';
					...
					if(results[i].check_out_time__c != null) body += '"Status__c":"' + results[i].check_out_time.replace(" ", "T") + '", ';
