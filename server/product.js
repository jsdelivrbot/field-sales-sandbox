...
exports.createProduct = function(req, res, next) {
	...
	query += "Shelf_Life__c, Shelf_Stall__c, Size_in_Grams__c, StockKeepingUnit, ";
	...
	query += req.body.container + "', '" + req.body.dimensionheight + "', '" + req.body.multipack + "', '" + req.body.netweight + "', '";
