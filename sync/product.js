...
exports.sync = function(req, res, next) {
  ...
  auth.authen(head)
	.then(function(obj) {
		...
		var query = "SELECT *, to_char( systemmodstamp + interval '7 hour', 'YYYY-MM-DD HH24:MI:SS') as updatedate FROM salesforce.Product2 WHERE systemmodstamp + interval '7 hour' > '" + lastsync + "' order by ProductCode asc";
		db.select(query) 
